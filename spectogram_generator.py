...
class WavtoSpec:
    def __init__(self, src_dir, dst_dir):
        ...
        # Check and create src_dir if it doesn't exist
        if not os.path.exists(self.src_dir):
            os.makedirs(self.src_dir)
            print(f"Source directory '{self.src_dir}' created.")

        # Check and create dst_dir if it doesn't exist
        if not os.path.exists(self.dst_dir):
            os.makedirs(self.dst_dir)
            print(f"Destination directory '{self.dst_dir}' created.")
...
# Usage:
src = "/home/george-vengrovski/Documents/data/pretrain_song_detector"
dst = "/home/george-vengrovski/Documents/data/pretrain_song_detector_specs"

wav_to_spec = WavtoSpec(src, dst)
